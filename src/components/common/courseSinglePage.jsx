    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 py-10 px-6">
      <div className="max-w-4xl mx-auto bg-white shadow-2xl rounded-2xl p-8">
        <h1 className="text-4xl font-extrabold text-center text-blue-700 mb-10">
          Biaya <span className="text-teal-500">Preschool</span> dan <span className="text-teal-500">Daycare</span>
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-8">
          ...
          <div className="bg-blue-50 p-6 rounded-lg shadow-md">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-2xl font-semibold text-gray-800">Biaya Preschool</h2>
            </div>
          ...
          <div className="bg-teal-50 p-6 rounded-lg shadow-md">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-2xl font-semibold text-gray-800">Biaya Daycare</h2>
            </div>
            <ul className="space-y-3 text-gray-700">
              <li>
                <span>Pendaftaran:</span>{" "}
              ...
              <li>
                ...
                <span className="font-bold text-teal-600">Rp 75.000,- / hari</span>
              </li>
              <li>
                <span>Sabtu/Ahad:</span>{" "}
                <span className="font-bold text-teal-600">Sesuai kesepakatan</span>
              </li>
            </ul>
          </div>
        </div>
